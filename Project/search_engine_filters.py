...
def Advanced_Search_Engine(dataframe):
    ...
    card_checkboxes = [widgets.Checkbox(value=False, description=card) 
                      for card in unique_cards]
    service_checkboxes = [widgets.Checkbox(value=False, description=service) 
    ...
    def update_cuisines(change):
        ...
        if selected_city and 'cuisineType' in df.columns:
            ...
            if not city_data.empty:
                ...
                if cuisines:
                    cuisine_box.children = [
                        widgets.Checkbox(value=False, description=cuisine)
